...
#[cfg(any(crowded_field_source, test))]
pub mod crowded_field_source;
#[cfg(any(interstellar_medium_params, test))]
pub mod interstellar_medium_params;
#[cfg(any(interstellar_medium_spectra, test))]
pub mod interstellar_medium_spectra;
#[cfg(any(lens_candidates, test))]
pub mod lens_candidates;
#[cfg(any(lens_catalogue_name, test))]
pub mod lens_catalogue_name;
#[cfg(any(lens_observation, test))]
pub mod lens_observation;
#[cfg(any(lens_outlier, test))]
