...
//! This module contains all the known columns in the ppmxl_neighbourhood table.

use crate::traits::{Column, Table};

/// PPMXL Neighbourhood table includes all good neighbours for each matched
...
pub struct ppmxl_neighbourhood;

impl Table for ppmxl_neighbourhood {
    fn string(&self) -> String {
        "ppmxl_neighbourhood".to_string()
    }
}

/// The columns in the ppmxl_neighbourhood table.
#[allow(non_camel_case_types)]
...
pub enum Col {
    ...
    ppmxl_oid,
    /// The angular_distance_error column. (No further description available)
...
#[cfg(test)]
/// Collects all the known columns in the ppmxl_neighbourhood table.
pub fn collect_known(map: &mut std::collections::HashMap<String, Vec<String>>) {
    ...
    col_strings.push(Col::angular_distance_error.to_string());
    map.insert(ppmxl_neighbourhood.string(), col_strings);
}
