...
//! This module contains all the known columns in the tmass_best_neighbour table.

use crate::traits::{Column, Table};

/// 2MASS BestNeighbour table lists each matched Gaia object with its best
...
/// The columns in the tmass_best_neighbour table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the tmass_best_neighbour table.
