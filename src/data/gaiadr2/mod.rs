...
#[cfg(any(aux_allwise_agn_gdr2_cross_id, test))]
pub mod aux_allwise_agn_gdr2_cross_id;
#[cfg(any(aux_iers_gdr2_cross_id, test))]
pub mod aux_iers_gdr2_cross_id;
#[cfg(any(aux_sso_orbit_residuals, test))]
pub mod aux_sso_orbit_residuals;
#[cfg(any(aux_sso_orbits, test))]
pub mod aux_sso_orbits;
#[cfg(any(dr1_neighbourhood, test))]
...
#[cfg(any(panstarrs1_original_valid, test))]
...
#[cfg(any(ruwe, test))]
pub mod ruwe;
#[cfg(any(sdssdr9_best_neighbour, test))]
pub mod sdssdr9_best_neighbour;
#[cfg(any(sdssdr9_neighbourhood, test))]
...
#[cfg(any(tycho2_best_neighbour, test))]
pub mod tycho2_best_neighbour;
#[cfg(any(tycho2_neighbourhood, test))]
...
#[cfg(any(vari_time_series_statistics, test))]
