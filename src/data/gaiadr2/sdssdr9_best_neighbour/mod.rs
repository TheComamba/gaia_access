...
//! This module contains all the known columns in the sdssdr9_best_neighbour table.

use crate::traits::{Column, Table};

/// SDSS DR9 BestNeighbour table lists each matched Gaia object with its
...
/// The columns in the sdssdr9_best_neighbour table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the sdssdr9_best_neighbour table.
