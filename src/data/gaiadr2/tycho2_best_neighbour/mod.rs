...
//! This module contains all the known columns in the tycho2_best_neighbour table.
...
impl Table for tycho2_best_neighbour {
    fn string(&self) -> String {
        "tycho2_best_neighbour".to_string()
    }
}

/// The columns in the tycho2_best_neighbour table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the tycho2_best_neighbour table.
pub fn collect_known(map: &mut std::collections::HashMap<String, Vec<String>>) {
    ...
    map.insert(tycho2_best_neighbour.string(), col_strings);
}
