...
//! This module contains all the known columns in the ppmxl_best_neighbour table.

use crate::traits::{Column, Table};

/// PPMXL BestNeighbour table lists each matched Gaia object with its best
/// neighbour in the external catalogue.
#[allow(non_camel_case_types)]
pub struct ppmxl_best_neighbour;

impl Table for ppmxl_best_neighbour {
    fn string(&self) -> String {
        "ppmxl_best_neighbour".to_string()
    }
}

/// The columns in the ppmxl_best_neighbour table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the ppmxl_best_neighbour table.
