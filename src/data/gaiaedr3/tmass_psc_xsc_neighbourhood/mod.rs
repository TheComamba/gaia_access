...
//! This module contains all the known columns in the tmass_psc_xsc_neighbourhood table.

use crate::traits::{Column, Table};

/// <p>2MASS Neighbourhood table includes all good neighbours for each matched Gaia object.
...
impl Table for tmass_psc_xsc_neighbourhood {
    fn string(&self) -> String {
        "tmass_psc_xsc_neighbourhood".to_string()
    }
}

/// The columns in the tmass_psc_xsc_neighbourhood table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the tmass_psc_xsc_neighbourhood table.
