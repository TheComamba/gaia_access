...
/// <p>Tycho2TDSCmerge BestNeighbour table lists each matched external catalogue object with its best
/// neighbour in Gaia.
...
#[cfg(test)]
/// Collects all the known columns in the tycho2tdsc_merge_best_neighbour table.
