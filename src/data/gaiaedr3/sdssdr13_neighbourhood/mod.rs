...
//! This module contains all the known columns in the sdssdr13_neighbourhood table.
...
impl Table for sdssdr13_neighbourhood {
    fn string(&self) -> String {
        "sdssdr13_neighbourhood".to_string()
    }
}

/// The columns in the sdssdr13_neighbourhood table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the sdssdr13_neighbourhood table.
