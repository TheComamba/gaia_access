...
/// <p>2MASS BestNeighbour table lists each matched Gaia object with its best neighbour in
...
#[cfg(test)]
/// Collects all the known columns in the tmass_psc_xsc_best_neighbour table.
