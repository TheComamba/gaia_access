...
/// <p>Pan-STARRS1 DR1 Neighbourhood table includes all good neighbours for each matched Gaia object.
...
#[cfg(test)]
/// Collects all the known columns in the panstarrs1_neighbourhood table.
