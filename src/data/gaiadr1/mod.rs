...
#[cfg(any(aux_qso_icrf2_match, test))] pub mod aux_qso_icrf2_match;
#[cfg(any(ext_phot_zero_point, test))] pub mod ext_phot_zero_point;
...
#[cfg(any(ppmxl_best_neighbour, test))] pub mod ppmxl_best_neighbour;
#[cfg(any(ppmxl_neighbourhood, test))] pub mod ppmxl_neighbourhood;
#[cfg(any(sdss_dr9_best_neighbour, test))] pub mod sdss_dr9_best_neighbour;
#[cfg(any(sdss_dr9_neighbourhood, test))] pub mod sdss_dr9_neighbourhood;
#[cfg(any(tmass_best_neighbour, test))] pub mod tmass_best_neighbour;
#[cfg(any(tmass_neighbourhood, test))] pub mod tmass_neighbourhood;
#[cfg(any(ucac4_best_neighbour, test))] pub mod ucac4_best_neighbour;
#[cfg(any(ucac4_neighbourhood, test))] pub mod ucac4_neighbourhood;
...
#[cfg(any(cepheid, test))] pub mod cepheid;
#[cfg(any(phot_variable_time_series_gfov, test))] pub mod phot_variable_time_series_gfov;
#[cfg(any(phot_variable_time_series_gfov_statistical_parameters, test))] pub mod phot_variable_time_series_gfov_statistical_parameters;
#[cfg(any(rrlyrae, test))] pub mod rrlyrae;
#[cfg(any(variable_summary, test))] pub mod variable_summary;
#[cfg(any(allwise_original_valid, test))] pub mod allwise_original_valid;
#[cfg(any(gsc23_original_valid, test))] pub mod gsc23_original_valid;
#[cfg(any(ppmxl_original_valid, test))] pub mod ppmxl_original_valid;
#[cfg(any(sdssdr9_original_valid, test))] pub mod sdssdr9_original_valid;
#[cfg(any(tmass_original_valid, test))] pub mod tmass_original_valid;
#[cfg(any(ucac4_original_valid, test))] pub mod ucac4_original_valid;
#[cfg(any(urat1_original_valid, test))] pub mod urat1_original_valid;
#[cfg(any(gaia_source, test))] pub mod gaia_source;
#[cfg(any(tgas_source, test))] pub mod tgas_source;
