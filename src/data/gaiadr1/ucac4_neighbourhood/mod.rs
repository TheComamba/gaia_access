...
//! This module contains all the known columns in the ucac4_neighbourhood table.

use crate::traits::{Column, Table};

/// UCAC4 implementation of BaseNeighbourhood
#[allow(non_camel_case_types)]
pub struct ucac4_neighbourhood;

impl Table for ucac4_neighbourhood {
    fn string(&self) -> String {
        "ucac4_neighbourhood".to_string()
    }
}

/// The columns in the ucac4_neighbourhood table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the ucac4_neighbourhood table.
pub fn collect_known(map: &mut std::collections::HashMap<String, Vec<String>>) {
    ...
    map.insert(ucac4_neighbourhood.string(), col_strings);
}
