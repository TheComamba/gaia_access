...
//! This module contains all the known columns in the sdss_dr9_best_neighbour table.

use crate::traits::{Column, Table};

/// URAT-1 implementation of BaseBestNeighbour
#[allow(non_camel_case_types)]
pub struct sdss_dr9_best_neighbour;

impl Table for sdss_dr9_best_neighbour {
    fn string(&self) -> String {
        "sdss_dr9_best_neighbour".to_string()
    }
}

/// The columns in the sdss_dr9_best_neighbour table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the sdss_dr9_best_neighbour table.
pub fn collect_known(map: &mut std::collections::HashMap<String, Vec<String>>) {
    ...
    map.insert(sdss_dr9_best_neighbour.string(), col_strings);
}
