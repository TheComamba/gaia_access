...
impl Schema for phot_variable_time_series_gfov_statistical_parameters {
...
col_strings.push(Col::iqr.to_string());
    map.insert(phot_variable_time_series_gfov_statistical_parameters.string(), col_strings);
}
