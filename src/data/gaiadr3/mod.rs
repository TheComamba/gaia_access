...
#[cfg(any(alerts_mixedin_sourceids, test))]
...
#[cfg(any(astrophysical_parameters, test))]
pub mod astrophysical_parameters;
#[cfg(any(astrophysical_parameters_supp, test))]
pub mod astrophysical_parameters_supp;
#[cfg(any(binary_masses, test))]
pub mod binary_masses;
#[cfg(any(chemical_cartography, test))]
...
#[cfg(any(gaia_crf3_xm, test))]
pub mod gaia_crf3_xm;
#[cfg(any(gaia_source, test))]
pub mod gaia_source;
#[cfg(any(gaia_source_lite, test))]
...
#[cfg(any(galaxy_candidates, test))]
pub mod galaxy_candidates;
#[cfg(any(galaxy_catalogue_name, test))]
pub mod galaxy_catalogue_name;
#[cfg(any(gold_sample_carbon_stars, test))]
pub mod gold_sample_carbon_stars;
#[cfg(any(gold_sample_fgkm_stars, test))]
pub mod gold_sample_fgkm_stars;
#[cfg(any(gold_sample_oba_stars, test))]
pub mod gold_sample_oba_stars;
#[cfg(any(gold_sample_solar_analogues, test))]
pub mod gold_sample_solar_analogues;
#[cfg(any(gold_sample_spss, test))]
pub mod gold_sample_spss;
#[cfg(any(gold_sample_ucd, test))]
...
#[cfg(any(nss_acceleration_astro, test))]
pub mod nss_acceleration_astro;
#[cfg(any(nss_non_linear_spectro, test))]
pub mod nss_non_linear_spectro;
#[cfg(any(nss_two_body_orbit, test))]
pub mod nss_two_body_orbit;
#[cfg(any(nss_vim_fl, test))]
pub mod nss_vim_fl;
#[cfg(any(oa_neuron_information, test))]
pub mod oa_neuron_information;
#[cfg(any(oa_neuron_xp_spectra, test))]
...
#[cfg(any(qso_candidates, test))]
pub mod qso_candidates;
#[cfg(any(qso_catalogue_name, test))]
...
#[cfg(any(ravedr6_best_neighbour, test))]
pub mod ravedr6_best_neighbour;
#[cfg(any(ravedr6_join, test))]
pub mod ravedr6_join;
#[cfg(any(ravedr6_neighbourhood, test))]
pub mod ravedr6_neighbourhood;
#[cfg(any(science_alerts, test))]
...
#[cfg(any(sso_observation, test))]
pub mod sso_observation;
#[cfg(any(sso_orbits, test))]
pub mod sso_orbits;
#[cfg(any(sso_reflectance_spectrum, test))]
pub mod sso_reflectance_spectrum;
#[cfg(any(sso_source, test))]
pub mod sso_source;
#[cfg(any(synthetic_photometry_gspc, test))]
...
#[cfg(any(total_galactic_extinction_map, test))]
pub mod total_galactic_extinction_map;
#[cfg(any(total_galactic_extinction_map_opt, test))]
...
#[cfg(any(vari_agn, test))]
pub mod vari_agn;
#[cfg(any(vari_cepheid, test))]
pub mod vari_cepheid;
#[cfg(any(vari_classifier_class_definition, test))]
pub mod vari_classifier_class_definition;
#[cfg(any(vari_classifier_definition, test))]
pub mod vari_classifier_definition;
#[cfg(any(vari_classifier_result, test))]
pub mod vari_classifier_result;
#[cfg(any(vari_compact_companion, test))]
pub mod vari_compact_companion;
#[cfg(any(vari_eclipsing_binary, test))]
pub mod vari_eclipsing_binary;
#[cfg(any(vari_epoch_radial_velocity, test))]
pub mod vari_epoch_radial_velocity;
#[cfg(any(vari_long_period_variable, test))]
pub mod vari_long_period_variable;
#[cfg(any(vari_microlensing, test))]
pub mod vari_microlensing;
#[cfg(any(vari_ms_oscillator, test))]
pub mod vari_ms_oscillator;
#[cfg(any(vari_planetary_transit, test))]
pub mod vari_planetary_transit;
#[cfg(any(vari_planetary_transit_13june2022, test))]
pub mod vari_planetary_transit_13june2022;
#[cfg(any(vari_rad_vel_statistics, test))]
pub mod vari_rad_vel_statistics;
#[cfg(any(vari_rotation_modulation, test))]
pub mod vari_rotation_modulation;
#[cfg(any(vari_rrlyrae, test))]
pub mod vari_rrlyrae;
#[cfg(any(vari_short_timescale, test))]
pub mod vari_short_timescale;
#[cfg(any(vari_spurious_signals, test))]
pub mod vari_spurious_signals;
#[cfg(any(vari_summary, test))]
pub mod vari_summary;
#[cfg(any(xp_summary, test))]
pub mod xp_summary;
