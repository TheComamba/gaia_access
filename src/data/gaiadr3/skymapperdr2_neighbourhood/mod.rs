...
/// <p>SkyMapper DR2 Neighbourhood table includes all good neighbours for each matched Gaia object.
...
#[cfg(test)]
/// Collects all the known columns in the skymapperdr2_neighbourhood table.
