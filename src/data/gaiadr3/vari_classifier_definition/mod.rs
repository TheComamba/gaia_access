...
//! This module contains all the known columns in the vari_classifier_definition table.

use crate::traits::{Column, Table};

/// Table with detailed descriptions of all classifiers used in table {\tt VariClassifierResult}.
...
/// The columns in the vari_classifier_definition table.
#[allow(non_camel_case_types)]
...
pub enum Col {
    ...
    classifier_name,
    /// Description of this classifier
...
#[cfg(test)]
/// Collects all the known columns in the vari_classifier_definition table.
