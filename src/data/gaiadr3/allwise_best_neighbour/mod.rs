...
//! This module contains all the known columns in the allwise_best_neighbour table.

use crate::traits::{Column, Table};

/// <p>allWISE BestNeighbour table lists each matched Gaia object with its best neighbour in the external catalogue.
...
pub struct allwise_best_neighbour;

impl Table for allwise_best_neighbour {
    fn string(&self) -> String {
        "allwise_best_neighbour".to_string()
    }
}

/// The columns in the allwise_best_neighbour table.
#[allow(non_camel_case_types)]
...
#[cfg(test)]
/// Collects all the known columns in the allwise_best_neighbour table.
pub fn collect_known(map: &mut std::collections::HashMap<String, Vec<String>>) {
    ...
    map.insert(allwise_best_neighbour.string(), col_strings);
}
