...
/// <p>SkyMapper DR2 BestNeighbour table lists each matched Gaia object with its best neighbour in
...
#[cfg(test)]
/// Collects all the known columns in the skymapperdr2_best_neighbour table.
